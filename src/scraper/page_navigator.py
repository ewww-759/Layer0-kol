...
class PageNavigator:
    ...
    async def scroll_for_comments(
        ...
        *,
        ...
        appeared. The loop exits when any stop condition is met.
        ...
        Args:
            ...
            stale_limit:      Stop after this many consecutive ticks
                              with no new content (scroll height unchanged).
            target_captures:  Stop after the interceptor captures this many
                              new responses during the scroll (0 = disabled).

        Returns:
            A ScrollResult summarizing the scroll session.
        """
        logger.info(
            ...
            f"stale_limit={stale_limit} target_captures={target_captures}"
        )
